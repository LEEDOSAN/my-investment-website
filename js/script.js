...
if (signupForm) {
    signupForm.addEventListener('submit', function(e) {
        ...
        const formData = {
            ...
            'investment-amount': document.getElementById('investment-amount').value,
            'inflow-path': document.getElementById('inflow-path').value,
...
function addFormField(fieldName, fieldConfig) {
    ...
    // 어드민에도 자동으로 반영되도록 이벤트 발생
    window.dispatchEvent(new CustomEvent('formFieldAdded', {
        detail: { fieldName, fieldConfig }
    }));
}
